...
/caps-man security
add authentication-types=wpa2-psk encryption=aes-ccm name=security1 passphrase=EXAMPLE_PASS
/caps-man configuration
add channel=channel1 country=russia datapath=datapath1 distance=indoors hw-protection-mode=rts-cts installation=indoor mode=ap name=cfg1 rx-chains=0,1,2 security=security1 ssid=GW-HOME.38 tx-chains=0,1,2
/interface list
add name=WAN
add name=LAN
/ip pool
...
add action=reject allow-signal-out-of-range=10s disabled=no mac-address=00:00:00:00:00:00 mac-address-mask=00:00:00:00:00:00 ssid-regexp=""
/caps-man manager
set enabled=yes
