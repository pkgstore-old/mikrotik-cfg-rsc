...
add address=10.0.0.0/16 dns-server=1.1.1.1,1.0.0.1 domain=home.local gateway=10.0.0.1 netmask=24 ntp-server=129.6.15.28,129.6.15.29,129.6.15.30,132.163.96.1,132.163.96.2,132.163.96.3
/ip firewall filter
